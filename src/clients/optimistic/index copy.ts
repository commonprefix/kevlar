...
//   async getCommittee(period: number, proverIndex: number): Promise<Uint8Array[]> {
...
//     const expectedCommitteeHash = await this.checkCommitteeHashAt(period);
//     if (!isUint8ArrayEq(committeeHash, expectedCommitteeHash))
...
//   ): Promise<boolean> {
//     console.log(proverIndex)
//     console.log(expectedCommitteeHash)
//     console.log(period)
//     console.log(prevCommittee)
